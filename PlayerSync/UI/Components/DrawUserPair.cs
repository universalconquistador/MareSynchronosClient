...
public class DrawUserPair
{
    ...
    private void DrawLeftSide()
    {
        ...
        if (_pair.IsPaused)
        {
            using var _ = ImRaii.PushColor(ImGuiCol.Text, _wasHovered ? UiSharedService.GetDarkerColor(ImGuiColors.DalamudYellow) : ImGuiColors.DalamudYellow);
        ...
        {
            using var _ = ImRaii.PushColor(ImGuiCol.Text, _wasHovered ? UiSharedService.GetDarkerColor(ImGuiColors.DalamudRed) : ImGuiColors.DalamudRed);
        ...
        else if (_pair.IsVisible)
        {
            ...
            _uiSharedService.IconText(FontAwesomeIcon.Eye, _wasHovered ? UiSharedService.GetDarkerColor(visibleColor) : visibleColor);
        ...
        else
        {
            ...
            using var _ = ImRaii.PushColor(ImGuiCol.Text, _wasHovered ? UiSharedService.GetDarkerColor(onlineColor) : onlineColor);
                ...
                || _performanceConfigService.Current.WarnOnPreferredPermissionsExceedingThresholds))
        {
            ...
            _uiSharedService.IconText(FontAwesomeIcon.ExclamationTriangle, _wasHovered ? UiSharedService.GetDarkerColor(ImGuiColors.DalamudYellow) : ImGuiColors.DalamudYellow);
    ...
    private float DrawRightSide()
    {
        ...
        if (_pair.IsPaired)
        {
            ...
            if (individualAnimDisabled || individualSoundsDisabled || individualVFXDisabled || individualIsSticky)
            {
                ...
                using (ImRaii.PushColor(ImGuiCol.Text, _wasHovered ? UiSharedService.GetDarkerColor(iconColor) : iconColor))
                ...
                if (ImGui.IsItemHovered())
                {
                    ...
                    if (individualIsSticky)
                    {
                        ...
                        _uiSharedService.IconText(individualIcon, _wasHovered ? UiSharedService.GetDarkerColor(individualAccentColor) : individualAccentColor);
                    ...
                    if (individualSoundsDisabled)
                    {
                        ...
                        _uiSharedService.IconText(FontAwesomeIcon.VolumeOff, _wasHovered ? UiSharedService.GetDarkerColor(currentTextColor) : currentTextColor);
                        ImGui.SameLine(40 * ImGuiHelpers.GlobalScale);
                        ImGui.AlignTextToFramePadding();
                    ...
                    if (individualAnimDisabled)
                    {
                        ...
                        _uiSharedService.IconText(FontAwesomeIcon.Stop, _wasHovered ? UiSharedService.GetDarkerColor(currentTextColor) : currentTextColor);
                        ImGui.SameLine(40 * ImGuiHelpers.GlobalScale);
                        ImGui.AlignTextToFramePadding();
                    ...
                    if (individualVFXDisabled)
                    {
                        ...
                        _uiSharedService.IconText(FontAwesomeIcon.Circle, _wasHovered ? UiSharedService.GetDarkerColor(currentTextColor) : currentTextColor);
                        ImGui.SameLine(40 * ImGuiHelpers.GlobalScale);
                        ImGui.AlignTextToFramePadding();
        ...
        if (_charaDataManager.SharedWithYouData.TryGetValue(_pair.UserData, out var sharedData))
        {
            ...
            _uiSharedService.IconText(FontAwesomeIcon.Running, _wasHovered ? UiSharedService.GetDarkerColor(accentColor) : accentColor);
        ...
        if (_currentGroup != null)
        {
            ...
            if (!string.IsNullOrEmpty(text))
            {
                ...
                _uiSharedService.IconText(icon, _wasHovered ? UiSharedService.GetDarkerColor(iconAccentColor) : iconAccentColor);
